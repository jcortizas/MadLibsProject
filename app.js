...
questionArray.push(`${query} a year in the future`);
...
for(let i = numberOfQuestions; i >= 0; i--){
    let tmp = prompt(`${questionArray[questionCounter]} (questions left ${numberOfQuestions-questionCounter})`);
    if(tmp !== ""){
        userInputs.push(tmp);
        console.log(` Answer ${questionCounter} --> ${userInputs[questionCounter]}`);
    } else {
        userInputs.push("<b>NO DATA</b>");
        console.log(`Answer ${questionCounter}:The user didn't write anything`);
    }
...
let originalStory = `<p>${userInputs[0]}. had been fed ${userInputs[1]} for decades, assessing ${userInputs[1]} and answering questions, allowing man to reach beyond the planetary confines of ${userInputs[4]}. However, in the year 2061,
 ...
 of the ${userInputs[11]} of the ${userInputs[3]} be reversed?' ${userInputs[0]}'s only response after much 'thinking' is 'INSUFFICIENT ${userInputs[1].toUpperCase()} FOR MEANINGFUL ANSWER'.</p>
 
 <p>The story jumps forward in time into later eras of ${userInputs[2]} and scientific development. These new eras highlight ${userInputs[2]}ity's goals of searching for "more"; more ${userInputs[6]}, more ${userInputs[7]}, more ${userInputs[8]} 
 ...
 ${userInputs[1].toUpperCase()} FOR A MEANINGFUL ANSWER."</p>

<p>In the last scene, the god-like descendant of ${userInputs[2]}ity, the unified mental process of over a trillion, trillion, trillion ${userInputs[2]}s who have spread throughout the ${userInputs[3]}, watches the stars flicker out, one by one,
...
demonstration. The story ends with ${userInputs[0]}'s pronouncement:</p>

<p>
    And ${userInputs[0]} said: "LET THERE BE ${userInputs[12].toUpperCase()}!" And there was ${userInputs[12]}"</p>`

console.log(originalStory);

document.write(`<h3> Your story: </h3>
<p>
${originalStory}
</p>`);

document.write(`<h3> Isaac Asimov original story plot <a href="https://en.wikipedia.org/wiki/The_Last_Question#Plot_summary">"The Last Question"</a>: </h3>
<p>Multivac had been fed data for decades, assessing data and answering questions, allowing man to reach beyond the planetary confines of Earth. However, in the year ${userInputs[5]},
    ...
    of the entropy of the universe be reversed?' Multivac's only response after much 'thinking' is 'INSUFFICIENT DATA FOR MEANINGFUL ANSWER'.</p>
    
    <p>The story jumps forward in time into later eras of human and scientific development. These new eras highlight humanity's goals of searching for "more"; more space, more energy, more planets 
    ...
    DATA FOR A MEANINGFUL ANSWER."</p>
   
   <p>In the last scene, the god-like descendant of humanity, the unified mental process of over a trillion, trillion, trillion humans who have spread throughout the universe, watches the stars flicker out, one by one,
   ...
   demonstration. The story ends with AC's pronouncement:</p>
   
    <p>And AC said: "LET THERE BE LIGHT!" And there was light—"</p>`);
